...
$select_userRequest="SELECT * FROM tbl_loan WHERE status=1";
                        ...
                        <!-- 
						 <header class="panel-heading">
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              <tr>
                                 <th><i class="icon_profile"></i> Loan ID</th>
                                 <th><i class="icon_calendar"></i> Loan Type</th>
                                 <th><i class="icon_mail_alt"></i> Persantage</th>
                                 <th><i class="icon_mail_alt"></i> creatDate</th>
							  ...
							  <?php
								if(mysqli_num_rows($data_sur)>0)
								{
									...
									{			
												if($row_sur[3]==0){$st='Disabled';}
												else if($row_sur[3]==1){$st=' Active';}
																			
							  ?>
							  <?php $id = $row_sur[0]; ?>
                              <tr>
                                 <td><?php echo$row_sur[0]; ?></td>
                                 <td><?php echo$row_sur[1]; ?></td>
                                 <td><?php echo$row_sur[2]; ?></td>
                                 <td><?php echo$row_sur[4]; ?></td>
                                 <td><?php echo$st; ?></td>
