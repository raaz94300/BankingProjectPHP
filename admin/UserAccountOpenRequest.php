...
$select_userRequest="SELECT * FROM tbl_account_request WHERE status=0";
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-square-o"></i>New Account Request</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
                              ...
                              <tr>
                                 ...
                                 <td>
                                  <div class="btn-group">
                                      ...
                                      <a class="btn btn-success" href="UserAccountOpenRequest_Accept.php?ar_id=<?php echo$id;?>"><i class="icon_check_alt2"></i></a>
                                      <a class="btn btn-danger" href="UserAccountOpenRequest_Reject.php?ar_id=<?php echo$id;?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr>
							  <?php
