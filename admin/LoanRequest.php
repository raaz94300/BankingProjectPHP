...
$select_userRequest="SELECT lr.loan_req_id, lr.createdate, lr.loanid,lr.createdate, lr.amount,  lr.duration, lr.status, lr.userid,l.loan_name,l.loan_persentage FROM tbl_loan_request lr, tbl_loan l WHERE  lr.loanid=l.loan_id AND lr.status=0";
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              <tr>
                                 ...
                                 <th><i class="icon_mobile"></i> Interest Rate</th>
							  ...
							  ?>
							  <?php $id = $row_sur['loan_req_id']; ?>
                              <tr>
                                 <td><?php echo$row_sur['loan_req_id']; ?></td>
                                 <td><?php echo$row_sur['loan_name']; ?></td>
                                 <td><?php echo$row_sur['amount']; ?></td>
                                 <td><?php echo$row_sur['duration']; ?> Years</td>
                                 <td><?php echo$row_sur['createdate']; ?></td>
                                 <td><?php echo$row_sur['loan_persentage']; ?> %</td>
                                 <td><?php echo$st; ?></td>

                                 <td>
                                  <div class="btn-group">
                                      <a class="btn btn-primary" href="LoanRequest_view.php?loan_req_id=<?php echo$id;?>"><i class="icon_plus_alt2"></i></a>
                                      
                                      <a class="btn btn-danger" href="LoanRequest_Reject.php?loan_req_id=<?php echo$id;?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr>
							  <?php
