...
$select_userRequest="SELECT * FROM tbl_account_request WHERE status=3";
...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i> Terminated Accounts</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="fa fa-bars"></i>Accounts</li>
						<li><i class="fa fa-square-o"></i>All Terminated Account</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
