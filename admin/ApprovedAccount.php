...
$select_userRequest="SELECT * FROM tbl_account_request WHERE status=1 OR  status=3";
...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i>Approved Accounts</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="fa fa-bars"></i>Accounts</li>
						<li><i class="fa fa-square-o"></i>All Approved Account </li>
					</ol>
				</div>
			</div>
              <!-- page start-->
						 ...
						 <header class="panel-heading">
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              ...
                              <tr <?php if($row_sur['status']==3){echo "class='terminated'";} ?> >
                                 ...
                                 <td>
                                  <div class="btn-group">
                                      ...
                                      <a class="btn btn-danger" href="TerminateAccount.php?userid=<?php echo$row_sur['userid'];?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr>
							  <?php
